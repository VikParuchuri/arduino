...
void loop()
{
  ...
  lightLevel = map(lightLevel,0,255,0,768);
  showRGB(lightLevel);
...
void showRGB(int color)
{
  ...
  // to those values
  analogWrite(ledPins[0], redIntensity);
  analogWrite(ledPins[1], blueIntensity);
  analogWrite(ledPins[2], greenIntensity);
}
