...
void loop()
{
  ...
  int sensorValue;
  int modified_sensorvalue;
  sensorValue = analogRead(SENSOR_PIN);
  modified_sensorvalue = (int) sensorValue/(1023/8);
  if(modified_sensorvalue>LED_COUNT)
  {
     modified_sensorvalue = LED_COUNT;
  }
  modified_sensorvalue = modified_sensorvalue - 1;
  blinkSelected(modified_sensorvalue);
...
void blinkSelected(int selected)
{
  int index;
